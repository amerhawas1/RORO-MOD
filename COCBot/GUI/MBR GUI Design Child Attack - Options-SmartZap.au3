...
Func CreateAttackNewSmartZap()
	...
	$y -= 55
		...
		$g_hTxtSmartZapMinDE = GUICtrlCreateInput("100", $x + 289, $y + 32, 90, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
		...
		$g_hTxtSmartExpectedDE = GUICtrlCreateInput("100", $x + 289, $y + 78, 90, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
