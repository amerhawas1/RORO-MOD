	...
	While 1
		...
		Switch $g_aiAttackStdDropSides[$g_iMatchMode]
			Case 0 ;Two sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				...
				SetLog("إسقاط الموجة الأولى من البرابرة", $COLOR_INFO)
				...
				SetLog("اسقاط اول موجة من الرماة", $COLOR_INFO)
				...
				SetLog("اسقاط الموجة الثانية من البرابرة", $COLOR_INFO)
				...
				SetLog("إسقاط الموجة الثانية من الرماة", $COLOR_INFO)
